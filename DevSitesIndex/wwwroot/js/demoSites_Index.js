            ...
            controller: ["$rootScope", "$scope", "dataService", function ($rootScope, $scope, dataService) {
                    ...
                    $scope.saveNewDevsiteTag = function () {
                        ...
                        function addDevSiteTechnologySuccess(data) {
                            ...
                            var newOrUpdatedRecord = { id: data[0].id, technology: { description: data[0].technology.description } };
                            var existingRecordIndex = $scope.theTags.devSiteTechnologies.findIndex(function (r) { return r.id == data[0].id; });
                    ...
                    $scope.confirmedRemoveDevSiteTag = function () {
                        ...
                        function deleteDevSiteTechnologySuccess(data) {
                            ...
                            console.log(data);
                            $scope.theTags.devSiteTechnologies = $scope.theTags.devSiteTechnologies.filter(function (t) { return t.id !== $scope.devSiteTechnologySelectedRecord.id; });
                            $scope.removingDevSiteTag = false;
                        }
