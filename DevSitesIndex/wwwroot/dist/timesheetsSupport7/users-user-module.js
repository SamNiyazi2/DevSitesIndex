...
module.exports = "\r\n\r\n<h3>Login</h3>\r\n\r\n<hr />\r\n\r\n<div class=\"col-md-4\">\r\n\r\n  <form #loginForm=\"ngForm\" autocomplete=\"off\" (ngSubmit)=\"login(loginForm.value)\" novalidate>\r\n\r\n    <div class=\"form-group\">\r\n      <label for=\"userName\">Email: </label>\r\n\r\n      <!--(input)=\"userName=$event.target.value\"-->\r\n      <em *ngIf=\"(loginForm.controls.email?.touched || mouseoverLogin) && loginForm.controls.email?.invalid\">Required</em>\r\n      <input (ngModel)=\"email\" name=\"email\"\r\n             id=\"userName\"\r\n             type=\"text\" class=\"form-control\" placeholder=\"Email...\" autofocus required />\r\n    </div>\r\n\r\n    <div class=\"form-group\">\r\n      <label for=\"password\">Password: </label>\r\n\r\n      <em *ngIf=\"(loginForm.controls.password?.touched || mouseoverLogin) && loginForm.controls.password?.invalid\">Required</em>\r\n\r\n      <input (ngModel)=\"password\" name=\"password\"\r\n             id=\"password\" type=\"password\" class=\"form-control\" placeholder=\"Password...\" required />\r\n\r\n    </div>\r\n    <span (mouseenter)=\"mouseoverLogin=true\" (mouseleave)=\"mouseoverLogin=false\">\r\n      <button type=\"submit\" class=\"btn btn-primary\" [disabled]=\"loginForm.invalid\">Login</button> &nbsp;\r\n    </span>\r\n\r\n    <button type=\"button\" class=\"btn btn-default\" (click)=\"cancel()\">Cancel</button>\r\n    <br />\r\n    <div [ngClass]=\"{error:feedbackMessage}\"\r\n         [innerHtml]=\"feedbackMessage\">\r\n    </div>\r\n    <br />\r\n    <br />\r\n    <input type=\"checkbox\" [(ngModel)]=\"displayProps\" name=\"displayProps\" value=\"true\" />\r\n  </form>\r\n\r\n</div>\r\n\r\n<div *ngIf=\"displayProps\">\r\n\r\n  <div class=\"col-md-3 col2\">\r\n    <dl class=\"dl-horizontal\">\r\n\r\n      <dt>loginForm.valid</dt>\r\n      <dd>{{loginForm.valid}}</dd>\r\n\r\n      <dt>loginForm.invalid</dt>\r\n      <dd>{{loginForm.invalid}}</dd>\r\n\r\n      <dt>loginForm.dirty</dt>\r\n      <dd>{{loginForm.dirty}}</dd>\r\n\r\n      <dt>loginForm.pristine</dt>\r\n      <dd>{{loginForm.pristine}}</dd>\r\n\r\n      <dt>loginForm.submitted</dt>\r\n      <dd>{{loginForm.submitted}}</dd>\r\n\r\n      <dt>loginForm.touched</dt>\r\n      <dd>{{loginForm.touched}}</dd>\r\n\r\n      <dt>loginForm.untouched</dt>\r\n      <dd>{{loginForm.untouched}}</dd>\r\n\r\n\r\n\r\n    </dl>\r\n\r\n  </div>\r\n\r\n\r\n  <div class=\"col-md-5 col3\">\r\n\r\n    <dl class=\"dl-horizontal\">\r\n\r\n      <dt>loginForm.controls.email.valid</dt>\r\n      <dd>{{loginForm.controls.email.valid}}</dd>\r\n\r\n      <dt>loginForm.controls.email.invalid</dt>\r\n      <dd>{{loginForm.controls.email.invalid}}</dd>\r\n\r\n      <dt>loginForm.controls.email.dirty</dt>\r\n      <dd>{{loginForm.controls.email.dirty}}</dd>\r\n\r\n      <dt>loginForm.controls.email.pristine</dt>\r\n      <dd>{{loginForm.controls.email.pristine}}</dd>\r\n\r\n      <dt>loginForm.controls.email.touched </dt>\r\n      <dd>{{loginForm.controls.email.touched}}</dd>\r\n\r\n      <dt>loginForm.controls.email.untouched </dt>\r\n      <dd>{{loginForm.controls  .email.untouched}}</dd>\r\n\r\n\r\n\r\n    </dl>\r\n  </div>\r\n\r\n</div>\r\n"
...
/***/ "./src/app/users/logout/logout.component.html":
/*!****************************************************!*\
  !*** ./src/app/users/logout/logout.component.html ***!
  \****************************************************/
/*! no static exports found */
...
module.exports = "<p>\r\n  logout works!\r\n</p>\r\n\r\n\r\n<app-child [data]=\"foods\" (removeTag_call)=\"removeTag($event)\"></app-child>\r\n\r\n<input #newTag type=\"text\" placeholder=\"Enter a new tag\" autofocus>\r\n<button (click)=\"addTag(newTag)\">Add tag</button>\r\n\r\n"
...
var LogoutComponent = /** @class */ (function () {
    ...
    LogoutComponent.prototype.ngOnInit = function () {
        ...
        var token = jquery__WEBPACK_IMPORTED_MODULE_4__("[name=__RequestVerificationToken]").val();
...
var ChildComponent = /** @class */ (function () {
    function ChildComponent() {
        this.removeTag_call = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    }
    ...
    ], ChildComponent.prototype, "removeTag_call", void 0);
...
module.exports = "\r\n<h3>Edit Profile</h3>\r\n<hr />\r\n<div class=\"col-md-6 panel\">\r\n\r\n\r\n  <form [formGroup]=\"profileForm\" autocomplete=\"off\" novalidate (ngSubmit)=\"saveProfile(profileForm.value)\">\r\n\r\n    <div class=\"form-group\" [ngClass]=\"{'error':!validFirstName()}\">\r\n      <label for=\"firstName\">First Name:</label>\r\n      <em *ngIf=\"!validFirstName() && profileForm.controls.firstName.errors.required\">Required</em>\r\n      <em *ngIf=\"!validFirstName() && profileForm.controls.firstName.errors.pattern\">Must start with a letter</em>\r\n      <em *ngIf=\"!validFirstName() && profileForm.controls.firstName.errors.maxlength\">Name cannot exceed 10 characters</em>\r\n      <input formControlName=\"firstName\" id=\"firstName\" type=\"text\" class=\"form-control\" placeholder=\"First name...\" autofocus />\r\n    </div>\r\n\r\n    <div class=\"form-group\" [ngClass]=\"{'error':!validLastName()}\">\r\n      <label for=\"lastName\">Last Name:</label>\r\n\r\n      <em *ngIf=\"!validLastName() && profileForm.controls.lastName.errors.required\">Required</em>\r\n      <em *ngIf=\"!validLastName() && profileForm.controls.lastName.errors.customValidator\">{{profileForm.controls.lastName.errors.customValidator}}</em>\r\n\r\n      <input formControlName=\"lastName\" id=\"lastName\" type=\"text\" class=\"form-control\" placeholder=\"Last name...\" />\r\n    </div>\r\n\r\n    <button type=\"submit\" class=\"btn btn-primary\">Save</button>\r\n    <button type=\"button\" class=\"btn btn-default\" (click)=\"cancel()\">Cancel</button>\r\n\r\n  </form>\r\n\r\n</div>\r\n\r\n"
...
var ProfileComponent = /** @class */ (function () {
    ...
    ProfileComponent.prototype.ngOnInit = function () {
        ...
        // Validators.required
        this.firstName = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](first, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].pattern('[a-zA-Z].*'), _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].maxLength(10)]);
        this.lastName = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](last, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _util_customValidators__WEBPACK_IMPORTED_MODULE_5__["customValidator"], _util_customValidators__WEBPACK_IMPORTED_MODULE_5__["customValidator_v02"](['aaa', 'bbb'])]);
        this.profileForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"]({ firstName: this.firstName, lastName: this.lastName });
    };
...
/* harmony import */ var _login_login_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./login/login.component */ "./src/app/users/login/login.component.ts");
    ...
    UserModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            declarations: [
                ...
                _logout_logout_component__WEBPACK_IMPORTED_MODULE_8__["ChildComponent"]
            ],
            providers: []
        })
    ], UserModule);
