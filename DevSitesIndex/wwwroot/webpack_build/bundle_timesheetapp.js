      ...
      return {
        ...
        link: function link(scope, elem, attr, ngModel) {
          ...
          ngModel.$parsers.unshift(function (value) {
            ...
            console.log('44) -------------------------------');
            console.log(attr);
            console.log('55) -------------------------------'); //ngModel.$setValidity(attr.name + '.dropdownListDirectiveInputBox', dropdownListDirectiveInputBox.indexOf(value) === -1);
      ...
      var controller = ['$http', '$q', '$scope', '$rootScope', '$timeout', 'changeMonitorService', 'ssn_logger', function ($http, $q, $scope, $rootScope, $timeout, changeMonitorService, ssn_logger) {
        ...
        $scope.$on('dropdownListDirective_Change_start', function (events, args) {
          ...
          if (vm.parentKeyName && vm.parentKeyName == args.keyColumn) {
            ...
            isHandled = true; //console.log('Update vm.parentKeyColumn = args.keyValue');
            //console.log(vm.parentKeyColumn);
            //console.log(args.keyValue);
          }
          ...
          if (args.msg == "select new value") {
            ...
            vm.ngModel = null; //////////////////////////////////////////////////////////////////$("[name='" + vm.keyColumn + "']").val('');
            //////////////////////////////////////////////////////  vm.disciplineSelected_XXX = "";

            isHandled = true;
          }

          if (!isHandled) {//ssn_logger.cl_normal({ callSource: '20210609-0547', message: `dropdownListDirective_Change_start not handled - vm.keyColumn [${vm.keyColumn}]  ngModel [${vm.ngModel}]   parentKeyColumn [${vm.parentKeyColumn}]` }, 'red');
        ...
        $scope.$watch('vm101.parentKeyColumn', function (newValue, oldValue) {
          ...
          if (oldValue != newValue && oldValue != null) {
            ...
            vm.isValidBoolean = false; //console.log('%c20210608-0054-B - parent key value changed - reset local key   keyColumn [${vm.keyColumn}]  parentKeyColumn [${vm.parentKeyColumn}]', 'color:yellow;font-size:20px;');
        ...
        vm.getDisciplines = function (lookupValue) {
          ssn_logger.cl_normal({
            callSource: "20210609-1532",
            message: "getDisciplines  getDisciplines "
          }, "white", true);
          ...
          try {
            ...
            ssn_logger.cl_normal({
              callSource: "20210607-1607-B",
              message: vm.callSource
            }, "yellow");
          }
          ...
          function typeaheadDisciplineSuccess(response) {
            ssn_logger.cl_normal({
              callSource: "20210609-1547",
              message: "Got data for [" + vm.callSource
            }, "yellow", true);
            var addresses = [];
...
/* harmony import */ var angular__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! angular */ "angular");
/* harmony import */ var angular__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(angular__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _Util_ApplicationInsights_Monitor__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../Util/ApplicationInsights_Monitor */ "./Util/ApplicationInsights_Monitor.js");
...
_Util_ApplicationInsights_Monitor__WEBPACK_IMPORTED_MODULE_2__["AppInsights_Util"].doSetup("LineItemController");
...
var lineItemController_instance = function () {
  var doSetup = function doSetup() {
    ...
    function lineItemControllerFunction($uibModalInstance, $scope, dataService, changeMonitorService, ssn_logger, jobId, containerViewValue) {
      ssn_logger.cl_normal({
        callSource: '20210606-1912',
        message: 'Definition'
      }, 'red', true);
      ssn_logger.cl_normal({
        callSource: '20210606-1912-B',
        message: "jobId [" + jobId + "]"
      }, 'red', true);
      _Util_ApplicationInsights_Monitor__WEBPACK_IMPORTED_MODULE_2__["AppInsights_Util"].logEvent("DemoSites_20210606_1514", {
      ...
      function getJobCatch(err) {
        ...
        ssn_logger.cl_error({
          ...
          message: "getJobCatch -Failed to get record",
          errorObject: err
        });
        ...
        try {
          ...
          if (promise) {
            promise.then(function (data) {
              $scope.job_Lineitem = angular__WEBPACK_IMPORTED_MODULE_1__["copy"]($scope.editableTimeLog);
...
var timesheetController_instance = function () {
  ...
  timesheetApp.controller('TimesheetController', ['$uibModal', '$scope', '$uibModalInstance', '$http', '$q', 'dataService', 'changeMonitorService', 'ssn_logger', 'timelogId_v01', function ($uibModal, $scope, $uibModalInstance, $http, $q, dataService, changeMonitorService, ssn_logger, timelogId_v01) {
    ...
    $scope.addNewLineItem = function (jobID, _containerViewValue) {
      ssn_logger.cl_normal({
        callSource: '20210609-1807-A',
        message: "Calling addNewLineItem"
      }, 'yellow', true);
      ssn_logger.cl_normal({
        callSource: '20210609-1807-B',
        message: "jobID: [" + jobID + "]"
      }, 'yellow', true);
      ssn_logger.cl_normal({
        callSource: '20210609-1807-c',
...
var timesheetCreateController_instance = function () {
  ...
  timesheetApp.controller('TimesheetCreateController', ['$uibModal', '$scope', '$uibModalInstance', '$http', '$q', 'dataService', 'changeMonitorService', 'ssn_logger', 'jobId', function ($uibModal, $scope, $uibModalInstance, $http, $q, dataService, changeMonitorService, ssn_logger, jobId) {
    ...
    $scope.addNewLineItem = function (jobID, _containerViewValue) {
      ssn_logger.cl_normal({
        callSource: '20210609-1801-A',
        message: 'Calling addNewLineItem'
      }, 'yellow', true);
      ssn_logger.cl_normal({
        callSource: '20210609-1801-B',
        message: "jobID [" + jobID + "]"
      }, 'yellow', true);
      ssn_logger.cl_normal({
        callSource: '20210609-1801-C',
        message: "containerViewValue [" + _containerViewValue + "]"
      }, 'yellow', true);
      $uibModal.open({
        templateUrl: '/js/timesheet/LineItem/LineItemTemplate.html',
...
/******/ });
//# sourceMappingURL=data:application/json;charset=utf-8;base64,