...
{
    public partial class Timelog_SummaryyWorkDayAndDisciplinerevisedsortdesc : Migration
    {
...
-- 11/04/2019 02:21 pm - SSN - Change sort (C#-v02)
...
-- 11/04/2019 02L13 pm - SSN - Change sort - dm.WeekEnding desc 
	 
SELECT 
		ROW_NUMBER() over ( order by dm.WeekEnding desc , DisciplineShort  ) SeqNo,
