...
{
    public partial class UniqueindexonTimeLogStartTime : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            delete from demosites.TimeLog where timelogid = 907
...
");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TimeLog_StartTime_Unique",
                schema: "DemoSites",
                table: "TimeLog",
                column: "StartTime",
                unique: true);
...
--					and cc.StartTime >= DemoSites.TimeLog.StartTime
	...
	if @openRecordCount = 1  and @TotalSeconds_sinceLastTimelog  > 4 * 60 * 60
		begin
			set @message = formatmessage( 'ssn-sql-20190928-1454 - Trying to automatically post period greater than four hours [%s]. Must fix manually.', convert ( varchar, convert ( decimal(5,2), round( @TotalSeconds_sinceLastTimelog / (60*60.0) ,2)  ) ))
		;
			throw 50000 , @message , 1
		end
